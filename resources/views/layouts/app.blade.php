                ...
                <div class="main-header-right">
                    ...
                    <div class="dropdown main-profile-menu">
                        <a class="main-img-user" href="{{ url('#') }}"><img alt="avatar"
                                src="{{ asset('/assets/img/brand/676-6764065_default-profile-picture-transparent-hd-png-download-removebg-preview.png') }}" style="border: 2px solid #8760fb;padding: 3px;"></a>
